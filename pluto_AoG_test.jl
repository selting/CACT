...
# ╔═╡ c6a8e182-86a3-11f1-3129-a5ffcb992d3a
using AlgebraOfGraphics, CairoMakie, GLMakie, PlutoUI

# ╔═╡ 5266b036-35c4-46e9-afed-b3bfc0426a82
@bind x Select([:bill_length_mm, :bill_depth_mm, :flipper_length_mm, :body_mass_g])

# ╔═╡ f359618a-e58a-4037-b23d-0fcadd1f42a3
begin
...
manifest_format = "2.0"
project_hash = "0f80c8707934beea8aa0d083b3129bd8522efcd0"

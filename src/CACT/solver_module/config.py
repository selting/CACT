...
from routing_module.objective_function import ObjectiveFunction, MinDistance, MinDuration
...
from solver_module.solver import CollaborativeSolver, IsolatedSolver
from tw_management_module import tw_selection as tws
...
def configs() -> Generator[CollaborativeSolver, Any, None]:
    ...
    s_objective: ObjectiveFunction = [MinDistance()]
